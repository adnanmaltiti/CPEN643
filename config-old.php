...
// $query= $sqlite_connect->exec("CREATE TABLE IF NOT EXISTS transactionssqlite(transactionid INTEGER PRIMARY KEY AUTOINCREMENT,
...
//$query= $sqlserver_connect->query("CREATE TABLE IF NOT EXISTS transactionssqlserv(transactionid INT identity(1,1) PRIMARY KEY, customer CHAR(100) NOT NULL, Address  CHAR(100) NOT NULL, goods    CHAR(100) NOT NULL, quantity CHAR(100) NOT NULL, transactiondate CHAR(100) NOT NULL, dbselect CHAR(100) NOT NULL);");
//End of table creation
